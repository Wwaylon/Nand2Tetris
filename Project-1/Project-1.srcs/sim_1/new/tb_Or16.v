...
module tb_Or16();
    ...
    initial begin
        ...
        #10
        if (out !== 16'b0000_0000_0000_0000) $display("Test case 1 failed");
        else $display("Test case 1 success");
        
        a = 16'b0000_0000_0000_0000;
        b = 16'b1111_1111_1111_1111;
        #10
        if (out !== 16'b1111_1111_1111_1111) $display("Test case 2 failed");
        else $display("Test case 2 success");
        
        a = 16'b1111_1111_1111_1111;
        b = 16'b0000_0000_0000_0000;
        #10
        if (out !== 16'b1111_1111_1111_1111) $display("Test case 3 failed");
        ...
        #10
        if (out !== 16'b1111_1111_1111_1111) $display("Test case 5 failed");
